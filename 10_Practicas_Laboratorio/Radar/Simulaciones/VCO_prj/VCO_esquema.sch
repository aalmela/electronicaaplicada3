...
<Properties>
  <View=-20,-18,1274,745,1.40362,790,0>
  <Grid=10,10,1>
  <DataSet=VCO_esquema.dat>
  <DataDisplay=VCO_esquema.dpl>
  <OpenDisplay=1>
  <Script=VCO_esquema.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Título>
...
<Components>
  <R R3 0 870 250 15 -26 0 1 "50 Ohm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "US" 0>
  ...
  <L L4 1 720 240 10 -26 0 1 "0 nH" 1 "" 0>
  ...
  <C C10 1 1050 180 -26 17 0 0 "1 pF" 1 "" 0 "neutral" 0>
  <C C9 0 960 60 -26 17 0 0 "1 pF" 1 "" 0 "neutral" 0>
  <GND * 5 1070 60 0 0 0 0>
  <GND * 5 1150 180 0 0 0 0>
  <GND * 5 800 270 0 0 0 0>
  <L L1 1 560 180 -26 10 0 0 "0 pH" 1 "" 0>
  <GND * 5 460 270 0 0 0 0>
  <Port Bias 1 870 10 -23 12 0 0 "2" 1 "analog" 0>
  ...
  <Port Out 1 1130 520 4 -50 0 2 "4" 1 "analog" 0>
...
<Wires>
  ...
  <1080 520 1130 520 "" 0 0 0 "">
  <870 420 930 420 "" 0 0 0 "">
