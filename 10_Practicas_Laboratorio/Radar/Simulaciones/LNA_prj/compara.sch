...
<Properties>
  <View=0,43,1907,815,1,0,60>
  <Grid=10,10,1>
  <DataSet=compara.dat>
  <DataDisplay=compara.dpl>
  <OpenDisplay=1>
  <Script=compara.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <Sub SUB1 1 570 390 -26 51 1 2 "BFU550W.sch" 0>
  <SPfile X3 1 500 640 -26 -59 0 0 "BFU550_03V3_015mA_NF_SP.s2p" 1 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
</Components>
<Wires>
